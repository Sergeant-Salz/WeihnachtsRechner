...
//for the christmas tree animation
...
function initCanvas() {
    $canvas = document.getElementById('christmas_tree');
...
function resize() {
    ...
    $canvas.style.width = `${_width / ratio * 0.7}px`;
    $canvas.style.height = `${_height / ratio * 0.7}px`;
    render();
}
...
function setColors() {
    ...
    _color.background = `hsla(${nh},${ns * 0.5}%,85%,0.0)`
}
